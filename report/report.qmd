...
ggplot(data, aes(y = wind, x = tropicalstorm_force_diameter)) +
...
```{r}
# Scatter plot using ggplot2
ggplot(data, aes(y = wind, x = hurricane_force_diameter)) +
...
```
```{r}
ggplot(data, aes(x = tropicalstorm_force_diameter, y = hurricane_force_diameter)) +
